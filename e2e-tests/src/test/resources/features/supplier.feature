...
功能: 供应商信息 API
  ...
  场景: 禁用分页时列表返回全部当前租户数据
    假如存在"供应商":
      ...
      | unpaged-oldest          | 9001     | 2024-01-01T00:00:00 |
      | unpaged-middle          | 9001     | 2024-01-02T00:00:00 |
      | unpaged-latest          | 9001     | 2024-01-03T00:00:00 |
      | unpaged-other-tenant    | 9002     | 2024-01-04T00:00:00 |
    当POST "/supplier/list":
      """
      {
        "pageIndex": 0,
